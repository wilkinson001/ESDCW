...
public class claim extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String rat = (String) request.getParameter("rat");
        String val_str = (String)request.getParameter("val");
        System.out.println(uname+" "+rat+" "+" "+val_str);
        double val = Double.parseDouble(val_str); 
        java.sql.Date date = java.sql.Date.valueOf((String)request.getParameter("date"));
        
        
        
        int id = jdbc.getMaxClaim()+1;

        jdbc.claim(id,uname,rat,val,date);
